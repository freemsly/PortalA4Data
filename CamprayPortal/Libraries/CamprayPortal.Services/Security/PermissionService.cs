...
namespace CamprayPortal.Services.Security
{
    ...
    public partial class PermissionService : IPermissionService
    {
        ...
        /// </remarks>
        private const string PERMISSIONS_ALLOWED_KEY = "CamprayPortal.permission.allowed-{0}-{1}";
        /// <summary>
        /// Key pattern to clear cache
        /// </summary>
        private const string PERMISSIONS_PATTERN_KEY = "CamprayPortal.permission.";
        #endregion
