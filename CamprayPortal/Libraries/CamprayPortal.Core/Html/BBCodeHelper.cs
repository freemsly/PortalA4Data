...
using CamprayPortal.Core.Html.CodeFormatter;

namespace CamprayPortal.Core.Html
{
    /// <summary>
    ...
    public partial class BBCodeHelper
    {
            ...
            bool replaceUnderline, bool replaceUrl, bool replaceCode, bool replaceQuote)
        {
            ...
            if (replaceUrl)
            {
                // format the url tags: [url=http://www.CamprayPortal.com]my site[/url]
                // becomes: <a href="http://www.CamprayPortal.com">my site</a>
                text = regexUrl1.Replace(text, "<a href=\"$1\" rel=\"nofollow\">$2</a>");

                // format the url tags: [url]http://www.CamprayPortal.com[/url]
                // becomes: <a href="http://www.CamprayPortal.com">http://www.CamprayPortal.com</a>
