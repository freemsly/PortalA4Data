...
namespace CamprayPortal.Services.Common
{
    ...
    public partial class GenericAttributeService : IGenericAttributeService
    {
        ...
        /// {1} : key group
        /// </remarks>
        private const string GENERICATTRIBUTE_KEY = "CamprayPortal.genericattribute.{0}-{1}";
        /// <summary>
        /// Key pattern to clear cache
        /// </summary>
        private const string GENERICATTRIBUTE_PATTERN_KEY = "CamprayPortal.genericattribute.";
        #endregion
