...
namespace CamprayPortal.Services.Helpers
{
    /// <summary>
    /// User agent helper
    /// </summary>
    public partial class UserAgentHelper : IUserAgentHelper
    {
        ...
        public virtual bool IsSearchEngine()
        {
            ...
            //more info: http://www.CamprayPortal.com/boards/t/17711/unhandled-exception-request-is-not-available-in-this-context.aspx
            bool result = false;
            try
            {
