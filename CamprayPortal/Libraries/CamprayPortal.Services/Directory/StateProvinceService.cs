...
namespace CamprayPortal.Services.Directory
{
    ...
    public partial class StateProvinceService : IStateProvinceService
    {
        ...
        /// {1} : country ID
        /// </remarks>
        private const string STATEPROVINCES_ALL_KEY = "CamprayPortal.stateprovince.all-{0}";
        /// <summary>
        /// Key pattern to clear cache
        /// </summary>
        private const string STATEPROVINCES_PATTERN_KEY = "CamprayPortal.stateprovince.";
